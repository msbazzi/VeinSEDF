...
def main():
    ...
    ap.add_argument("--joint_ft_lr", type=float, default=1e-5, help="If >0, use this LR for BOTH base and polynomial during final fine‑tune")
    ...
    ap.add_argument("--wtheta_boost", type=float, default=1.9)
