...
def main():
    ...
    ap.add_argument("--recruit_start_init", type=float, default=1.25,
    ...
    ap.add_argument("--gate_lambda", type=float, default=0.01, help="L1 penalty on gate values for sparsity")
    ...
    ap.add_argument("--max_iso_terms", type=int, default=5,
                help="Maximum number of symbolic isotropic correction terms to retain")
    ap.add_argument("--max_aniso_terms", type=int, default=5,
                help="Maximum number of symbolic anisotropic correction terms to retain")
    ap.add_argument("--max_cross_terms", type=int, default=6,
