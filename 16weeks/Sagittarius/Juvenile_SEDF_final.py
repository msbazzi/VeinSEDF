...
class CombinedEquationSEDF(SymbolicCrossMixin, nn.Module):
    ...
    Cross: fixed 8 symbolic terms consistently selected across specimens
             iso   : I2-3, <E_theta>, <E_z>
             aniso : <I4z-1>, <I4D1-1>, <I4D2-1>
             cross : <I2-3>·<E_z>, I8D1D2

    Equivalent to SimpleSEDF with pre-determined active_idx = [1,2,3,6,7,8,35,42].
...
def main():
    ...
    ap.add_argument("--joint_ft_epochs", type=int, default=5000)

    # LRs
    ap.add_argument("--lr_base",        type=float, default=5e-2)
    ap.add_argument("--lr_resid",       type=float, default=5e-2)
    ap.add_argument("--lr_joint_base",  type=float, default=5e-3)
    ...
    ap.add_argument("--recruit_end_min", type=float, default=0.15,
