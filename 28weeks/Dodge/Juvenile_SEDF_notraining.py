...
class VeinSEDFDiscovered(nn.Module):
    ...
    def __init__(self, iso_model="poly", aniso_model="4fiber", *, use_recruitment=True,
        ...
        self.aniso = build_aniso_module(aniso_model, use_recruitment=use_recruitment,
                                        use_dispersion=use_dispersion)
        # Discovered cross-term weights; init to 0 so model starts identical to base Eq9
        ...
        self._w5 = nn.Parameter(torch.tensor(1.0, dtype=torch.float64))  # (I2-3)·log1p(I2-2)
...
def main():
    ...
    ap.add_argument("--recruit_start_init", type=float, default=0.7,
                help="Initial guess or fixed value for the shared recruitment start λ_lb")
    ap.add_argument("--recruit_start_min", type=float, default=0.3,
                help="Lower bound for the learned recruitment start λ_lb")
    ap.add_argument("--recruit_start_max", type=float, default=1.5,
                help="Upper bound for the learned recruitment start λ_lb")
    ap.add_argument("--recruit_end_min", type=float, default=1.2,
